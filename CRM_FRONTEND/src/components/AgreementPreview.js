  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col">
          ...
          {isLoading ? (
            ...
            <div className="h-full">
              ...
              <textarea
                ...
                className="w-full h-[calc(100%-2rem)] p-4 font-mono text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none"
                spellCheck={false}
              />
            </div>
          ) : (
            ...
            <div
              ...
              className="bg-white border border-gray-200 rounded-lg p-8 shadow-inner min-h-[400px]"
        ...
        {/* Footer Status Bar */}
        <div className="px-6 py-3 border-t border-gray-200 bg-gray-50 rounded-b-xl flex items-center justify-between text-sm text-gray-600">
          <div className="flex items-center gap-4">
            <span>
              Mode: <span className="font-medium text-gray-900">{isEditMode ? 'Editing' : 'Preview'}</span>
            </span>
            {hasChanges && (
